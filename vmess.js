                    ...
                    <tr class="border-b border-white/5 hover:bg-white/5 transition-all">
                        <td class="py-4 px-4">
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <div class="text-[12px] text-slate-400 font-bold flex flex-col items-center gap-1">\${proxy.ip}:\${proxy.port}</div>
                                </div>
                            </div>
                        </td>
                        <td class="py-4 px-4">
                            <span class="text-[12px] text-slate-400 font-bold flex flex-col items-center gap-1">\${proxy.isp}</span>
                        </td>
                        <td class="py-4 px-4 text-right relative dropdown-container">
                            ...
                            <div id="drop-\${id}" class="dropdown-menu">
                                ...
                                <button onclick="copyToClipboard('\${vmess}', this)" class="w-full bg-emerald-600 hover:bg-emerald-700 p-2 rounded-md text-[10px] font-bold text-white flex items-center justify-center gap-2">
                                    <i class="fas fa-bolt"></i> VMESS CONFIG
                                </button>
                            </div>
                        </td>
                    </tr>
